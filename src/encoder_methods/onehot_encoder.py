...
from utils.constants import POSITION_RESIDUES


class OneHotEncoder(Encoders):
    def __init__(
        self, dataset=None, sequence_column=None, ignore_columns=[], max_length=1024
    ) -> None:
        super().__init__(
            dataset=dataset,
    ...
    def run_process(self):
        if self.status:
            ...
            for index in self.dataset.index:
                ...
                matrix_coded.append(self.__coding_sequence(sequence))
