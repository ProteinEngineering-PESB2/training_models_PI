...
class Encoders(object):
    def __init__(
        self, dataset=None, sequence_column=None, ignore_columns=None, max_length=1024
    ) -> None:
    ...
    def process_length_sequences(self):
        ...
        self.dataset["is_valid_length"] = (
            (self.dataset["length_sequence"] <= self.max_length).astype(int).values
        )
